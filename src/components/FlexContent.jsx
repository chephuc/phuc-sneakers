...
const FlexContent = ({ ifExists, endPoint: { title, heading, text, img, btn, url } }) => {
  return (
    <div
      className={`flex items-center justify-center flex-col nike-container ${
    ...
    >
      ...
      <div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full mt-3">
        <img
          src={img}
          alt={`img/${heading}`}
